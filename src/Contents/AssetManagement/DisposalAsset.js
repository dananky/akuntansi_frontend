...
export const DisposalAsset = (props) => {
    ...
    return (         
        <div className="card mt-4">
            <div className="card-body">
                ...
                <h4>Dispose Asset List</h4>
                <hr/>
                <div className="mb-4">
                    <button className="btn btn-sm btn-secondary mr-2">Delete Asset</button>
                    <button className="btn btn-sm btn-secondary mr-2">Revert</button>     
                </div>

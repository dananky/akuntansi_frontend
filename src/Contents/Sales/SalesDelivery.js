...
export const SalesDelivery = () => {
    return (
        <div className="salesdelivery container mt-5">
            <div className="card">
                <div className="button-salesdelivery">
                ...
                <div className="card-body">
                    ...
                    <div className="card card-salesdelivery">
                        <div className="card-body">
                    ...
                    <div className="memo-salesdelivery">
                        <h6>Memo</h6>
                        <textarea name="memo-salesdelivery" id="memo-salesdelivery" rows="5"/>
                    </div>
                    <div className="button2-salesdelivery">

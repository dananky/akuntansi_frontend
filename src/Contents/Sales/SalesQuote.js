...
export const SalesQuote = () => {
    return (
        <div className="salesquote container mt-5">
            <div className="card">
                <div className="button-salesquote">
                ...
                <div className="card-body">
                    ...
                    <div className="card card-salesquote">
                        <div className="card-body">
                    ...
                    <div className="memo-salesquote">
                        <h6>Memo</h6>
                        <textarea name="memo-salesquote" id="memo-salesquote" rows="5"/>
                    </div>
                    <div className="button2-salesquote">

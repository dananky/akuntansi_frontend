...
export const PurchaseDelivery = () => {
    return (
        <div className="purchasedelivery container mt-5">
            <div className="card">
                <div className="button-purchasedelivery">
                ...
                <div className="card-body">
                    ...
                    <div className="card card-purchasedelivery">
                        <div className="card-body">
                    ...
                    <div className="memo-purchasedelivery">
                        <h6>Memo</h6>
                        <textarea name="memo-purchasedelivery" id="memo-purchasedelivery" rows="5"/>
                    </div>
                    <div className="button2-purchasedelivery">

...
export const PurchaseInvoice = () => {
    return (
        <div className="purchaseinvoice container mt-5">
            <div className="card">
                <div className="button-purchaseinvoice">
                ...
                <div className="card-body">
                    ...
                    <div className="card card-purchaseinvoice">
                        <div className="card-body">
                    ...
                    <div className="memo-purchaseinvoice">
                        <h6>Memo</h6>
                        <textarea name="memo-purchaseinvoice" id="memo-purchaseinvoice" rows="5"/>
                    </div>
                    <div className="button2-purchaseinvoice">
